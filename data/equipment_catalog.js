...
(function(window) {
  ...
  var universalConstants = [
    ...
    { id: "pillows_blanket", name: "Kopfkissen & Bettdecke", type: "environment", desc: "Beckenerhöhung, Schalldämpfung, Einkuscheln im Aftercare, Dämpfung" },
  ...
  var equipmentCatalog = [
    ...
    },
    {
      ...
      desc: "Hochelastischer Hautreiz mit lauter akustischer Resonanz ohne Verletzungsgefahr."
    },
    {
   ...
   */
  var validateDisciplineSetup = function(ritual) {
    var conflicts = [];
    var sanitized = JSON.parse(JSON.stringify(ritual || {}));

    if (Array.isArray(physicalConstraintRules)) {
      physicalConstraintRules.forEach(function(rule) {
        try {
   ...
   */
  var getActiveSessionEquipment = function(userActiveIds) {
    var universals = universalConstants || [];
    var fullCatalog = equipmentCatalog || [];
  ...
  window.universalConstants = universalConstants;
  window.equipmentCatalog = equipmentCatalog;
  window.physicalConstraintRules = physicalConstraintRules;
  window.validateDisciplineSetup = validateDisciplineSetup;
  window.getActiveSessionEquipment = getActiveSessionEquipment;
